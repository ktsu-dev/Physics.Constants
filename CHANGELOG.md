...
- Remove Directory.Build.props, Directory.Build.targets, and several PowerShell scripts for versioning and metadata management. Add copyright notice to Constants.cs. ([@matt-edmondson](https://github.com/matt-edmondson))
...
- Bump ktsu.PhysicalQuantity in the ktsu group ([@dependabot[bot]](https://github.com/dependabot[bot]))
